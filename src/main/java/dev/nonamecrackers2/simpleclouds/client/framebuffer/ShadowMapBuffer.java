...
public class ShadowMapBuffer implements AutoCloseable {
	...
	public ShadowMapBuffer(int viewWidth, int viewHeight, int texWidth, int texHeight, float near, float far,
			boolean withColor, boolean comparisonDepth) {
		...
		if (comparisonDepth) {
			...
			GlStateManager._texImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_DEPTH_COMPONENT, texWidth, texHeight, 0,
					GL11.GL_DEPTH_COMPONENT, GL11.GL_UNSIGNED_BYTE, (IntBuffer) null);
		} else {
		...
		if (withColor) {
			...
			GlStateManager._texParameter(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_WRAP_S, GL12.GL_CLAMP_TO_EDGE);
			GlStateManager._texParameter(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_WRAP_T, GL12.GL_CLAMP_TO_EDGE);
			GlStateManager._texImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_RGB8, texWidth, texHeight, 0, GL11.GL_RGB,
					GL11.GL_FLOAT, (IntBuffer) null);
		}
		...
		if (withColor)
			GlStateManager._glFramebufferTexture2D(GL30.GL_FRAMEBUFFER, GL30.GL_COLOR_ATTACHMENT0, GL11.GL_TEXTURE_2D,
	...
	public String toString() {
		return this.getClass().getSimpleName() + "[buffer=" + this.bufferId + ",depth=" + this.depthTextureId
				+ ",color=" + this.colorTextureId + ",width=" + this.texWidth + ",height=" + this.texHeight + "]";
	}
