...
public class InstanceableMesh {
	...
	public InstanceableMesh(int vertexBufferSize, int indexBufferSize, VertexFormat format,
			Consumer<ByteBuffer> vertexBufferGenerator, Function<ByteBuffer, Integer> indexBufferGenerator) {
	...
	// buffer.put((byte)-1); buffer.put((byte)0); buffer.put((byte)0);
	// buffer.put((byte)0);
	// buffer.putFloat(-1.0F); buffer.putFloat( 1.0F); buffer.putFloat(-1.0F);
	// buffer.put((byte)-1); buffer.put((byte)0); buffer.put((byte)0);
	// buffer.put((byte)0);
	...
	// //-y
	// buffer.putFloat(-1.0F); buffer.putFloat(-1.0F); buffer.putFloat(-1.0F);
	// buffer.put((byte)0); buffer.put((byte)-1); buffer.put((byte)0);
	// buffer.put((byte)0);
	// buffer.putFloat(-1.0F); buffer.putFloat(-1.0F); buffer.putFloat( 1.0F);
	// buffer.put((byte)0); buffer.put((byte)-1); buffer.put((byte)0);
	// buffer.put((byte)0);
	...
	// //-z
	// buffer.putFloat(-1.0F); buffer.putFloat( 1.0F); buffer.putFloat(-1.0F);
	// buffer.put((byte)0); buffer.put((byte)0); buffer.put((byte)-1);
	// buffer.put((byte)0);
	// buffer.putFloat(-1.0F); buffer.putFloat(-1.0F); buffer.putFloat(-1.0F);
	// buffer.put((byte)0); buffer.put((byte)0); buffer.put((byte)-1);
	// buffer.put((byte)0);
	...
	// buffer.rewind();
	// }, buffer -> {
	// buffer.putInt(0); buffer.putInt(1); buffer.putInt(2); buffer.putInt(0);
	// buffer.putInt(2); buffer.putInt(3); // -x
	// buffer.putInt(4); buffer.putInt(5); buffer.putInt(6); buffer.putInt(4);
	// buffer.putInt(6); buffer.putInt(7); // +x
	// buffer.putInt(8); buffer.putInt(9); buffer.putInt(10); buffer.putInt(8);
	// buffer.putInt(10); buffer.putInt(11); // -y
	// buffer.putInt(12); buffer.putInt(13); buffer.putInt(14); buffer.putInt(12);
	// buffer.putInt(14); buffer.putInt(15); // +y
	// buffer.putInt(16); buffer.putInt(17); buffer.putInt(18); buffer.putInt(16);
	// buffer.putInt(18); buffer.putInt(19); // -z
	// buffer.putInt(20); buffer.putInt(21); buffer.putInt(22); buffer.putInt(20);
	// buffer.putInt(22); buffer.putInt(23); // +z
	// buffer.rewind();
	// return 36;
	// });
	// }
	...
	public static InstanceableMesh defaultCube() {
		return new InstanceableMesh(288, 144, DefaultVertexFormat.POSITION, buffer -> {
			buffer.putFloat(-1.0F);
			buffer.putFloat(-1.0F);
			buffer.putFloat(-1.0F);
			buffer.putFloat(-1.0F);
